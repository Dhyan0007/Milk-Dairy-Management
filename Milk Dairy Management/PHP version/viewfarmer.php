...
<body>
    ...
    <h1 class="h1 text-center display-4 mt-5"><font color='white'>FARMER DETAILS</h1>
    <div class="container pl-5 pr-5 mt-5">
        <table class="table">
			...
			<td><font color='white'><?php echo $row['fname']; ?></td>
                        <td><font color='white'><?php echo $row['address']; ?></td>
